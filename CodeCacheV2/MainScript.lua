...
local win = DiscordLib:Window("CodeCacheV2 Re-made by SynthX, A Nerd, Vxalware, and sstvskids")
...
local drops = serv:Channel("H Game Scripts")

local drops = serv:Channel("I Game Scripts")

local drops = serv:Channel("J Game Scripts")

local drops = serv:Channel("K Game Scripts")

local drops = serv:Channel("L Game Scripts")

local drops = serv:Channel("M Game Scripts")

local drops = serv:Channel("N Game Scripts")

local drops = serv:Channel("O Game Scripts")
...
local drops = serv:Channel("V Game Scripts")

local drops = serv:Channel("W Game Scripts")

local drops = serv:Channel("X Game Scripts")

local drops = serv:Channel("Y Game Scripts")

local drops = serv:Channel("Z Game Scripts")
