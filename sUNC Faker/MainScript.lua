...
warn("❌ debug.setupvalue returned nil, indicating the upvalue may not exist or the index is incorrect")
...
task.wait(0.01)
print("Interesting")
task.wait(0.35) -- For good measures
...
print("\n")
print("sUNC, VERSION 1.51 n?ÿrn?z|v{nv{??qrö{v{vy")
